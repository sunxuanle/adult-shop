const PRODUCTS = [
    ...
    },
    {
        ...
        price: 35.9,
        originalPrice: 59.9,
        image: 'https://picsum.photos/seed/condom-textured/300/300',
        images: ['https://picsum.photos/seed/condom-gift/300/300', 'https://picsum.photos/seed/condom-collection/300/300'],
        description: '颗粒纹理设计，增加刺激感。12只装，凸点设计。',
        specs: ['12只装', '凸点款', '螺纹款'],
        sales: 1890,
        stock: 400,
        features: ['颗粒纹理', '刺激快感', '安全可靠', '独立包装']
    },
    {
        id: 14,
        name: '持久延时安全套',
        ...
        price: 45.9,
        originalPrice: 79.9,
        image: 'https://picsum.photos/seed/condom-delay/300/300',
        images: ['https://picsum.photos/seed/condom-premium/300/300', 'https://picsum.photos/seed/condom-luxury/300/300'],
        description: '含苯佐卡因延时成分，延长性爱时间。10只装。',
        specs: ['10只装', '延时款'],
        sales: 1560,
        stock: 300,
        features: ['延时成分', '持久耐用', '安全有效', '舒适贴合']
    },
    {
        id: 15,
        name: '情趣内衣盲盒',
        ...
        price: 68.0,
        originalPrice: 99.0,
        image: 'https://picsum.photos/seed/lingerie-box/300/300',
        images: ['https://picsum.photos/seed/mystery-box/300/300', 'https://picsum.photos/seed/surprise-box/300/300'],
        description: '神秘盲盒，随机款式。超值惊喜，多种风格随机发放。',
        specs: ['均码', '随机款式'],
        sales: 2340,
        stock: 500,
        features: ['神秘惊喜', '超值优惠', '随机款式', '精美包装']
    },
    {
        id: 16,
        name: 'HPV安全检测试纸',
        ...
        price: 198.0,
        originalPrice: 298.0,
        image: 'https://picsum.photos/seed/hpv-test/300/300',
        images: ['https://picsum.photos/seed/medical-test/300/300', 'https://picsum.photos/seed/health-check/300/300'],
        description: 'HPV病毒检测试纸，居家自测，15分钟出结果。女性专用。',
        specs: ['1人份', '2人份'],
        sales: 890,
        stock: 200,
        features: ['居家自测', '快速出结果', '准确可靠', '隐私保护']
    }
];
